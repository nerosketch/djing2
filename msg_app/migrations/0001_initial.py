    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='usr_msg_status', to='profiles.UserProfile')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='message',
            name='account_status',
            field=models.ManyToManyField(through='msg_app.MessageStatus', to='profiles.UserProfile'),
        ),
        migrations.AddField(
            model_name='message',
            name='author',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='profiles.UserProfile'),
        ),
        migrations.AddField(
            model_name='message',
            name='conversation',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='memberships', to='profiles.UserProfile')),
                ('conversation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='msg_app.Conversation')),
                ('who_invite_that_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='self_conversations', to='profiles.UserProfile')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='participants',
            field=models.ManyToManyField(help_text='for select multiple press ctrl and click on field', related_name='conversations', through='msg_app.ConversationMembership', to='profiles.UserProfile', verbose_name='Participants'),
        ),
    ]
