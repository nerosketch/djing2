...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='participants',
            field=models.ManyToManyField(help_text='for select multiple press ctrl and click on field', related_name='conversations', through='msg_app.ConversationMembership', to=settings.AUTH_USER_MODEL, verbose_name='Participants'),
        ),
    ]
