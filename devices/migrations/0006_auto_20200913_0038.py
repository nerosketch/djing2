...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            name='device',
            options={'ordering': ('id',), 'permissions': [('can_remove_from_olt', 'Can remove from OLT'), ('can_fix_onu', 'Can fix onu'), ('can_apply_onu_config', 'Can apply onu config')], 'verbose_name': 'Device', 'verbose_name_plural': 'Devices'},
        ),
        migrations.AlterModelOptions(
            name='port',
