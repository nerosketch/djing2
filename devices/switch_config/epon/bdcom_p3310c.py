...
class BDCOM_P3310C(BasePONInterface):
    ...
    def get_fibers(self):
        fibers = tuple({
            ...
            'fb_active_onu': safe_int(self.get_item(
                '.1.3.6.1.4.1.3320.101.6.1.1.21.%d' % int(fiber_id))
            ),
        ...
        } for fiber_num, (registered_onu_count, fiber_id) in enumerate(self.get_list_keyval('.1.3.6.1.4.1.3320.101.6.1.1.2'), 1))
        return fibers
