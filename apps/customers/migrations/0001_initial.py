    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ip_address",
                    models.GenericIPAddressField(blank=True, null=True, default=None, verbose_name="Ip address"),
                ),
                ...
                (
                    ...
                    models.BooleanField(default=False, verbose_name="Automatically connect next service"),
                ),
                (
                    "markers",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "account",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="customers.Customer", verbose_name="Account"
                    ),
                ),
                (
                    "periodic_pay",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "customer",
                    models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to="customers.Customer"),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True, null=True, default=None, on_delete=django.db.models.deletion.SET_NULL, to="devices.Port"
            ),
        ),
        migrations.AddField(
            model_name="customer",
            name="device",
            field=models.ForeignKey(
                blank=True, null=True, default=None, on_delete=django.db.models.deletion.SET_NULL, to="devices.Device"
            ),
        ),
        migrations.AddField(
            model_name="customer",
