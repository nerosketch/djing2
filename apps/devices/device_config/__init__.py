...
from devices.device_config import unknown_device
...
DEVICE_TYPES = [
    (DEVICE_TYPE_UNKNOWN, unknown_device.UnknownDevice),
...
DEVICE_SWITCH_TYPES = (
    DEVICE_TYPE_DlinkDGS1100_10ME,
    DEVICE_TYPE_EltexSwitch,
    DEVICE_TYPE_HuaweiS2300,
    DEVICE_TYPE_DlinkDGS_3120_24SCSwitchInterface,
    DEVICE_TYPE_DlinkDGS_1100_06MESwitchInterface,
    DEVICE_TYPE_DlinkDGS_3627GSwitchInterface,
    DEVICE_TYPE_HuaweiS5300_10P_LI_AC,
)
