...
class DjingModelViewSet(ModelViewSet):
    ...
    def get_object_perms(self, request, *args, **kwargs):
        ...
        available_perms = Permission.objects.filter(content_type=get_content_type(obj))
        ...
        return Response({"availablePerms": available_perms})

    @action(detail=True, url_path=r"get_selected_object_perms/(?P<profile_group_id>\d+)")
