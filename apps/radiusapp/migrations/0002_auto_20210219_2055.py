...
def create_default_vlan(apps, schema_editor):
    ...
    if not vlan1.exists():
        VlanIf.objects.create(title="default", vid=1)
...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        on_delete=CASCADE, to="networks.CustomerIpLeaseModel", verbose_name="Ip lease"
                    ),
                ),
            ],
            options={
        ...
        migrations.RunSQL(sql=read_all_file("0002_auto_20210219_2055.sql", __file__)),
