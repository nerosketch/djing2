...
echo "User-Name=${client_radius_uname},
      ...
      ERX-Service-Activate:1='SERVICE-INET(${service_speed_in},${service_speed_in_burst},${service_speed_out},${service_speed_out_burst})'" \
      | radclient -sx 127.0.0.1 coa testing123
