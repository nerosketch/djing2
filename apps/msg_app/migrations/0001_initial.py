    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "state",
                    models.CharField(
                        choices=[("new", "New"), ("old", "Seen"), ("del", "Deleted")], default="new", max_length=3
                    ),
                ),
                (
                    "msg",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="msg_statuses", to="msg_app.Message"
                    ),
                ),
                (
                    "user",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="messages", to="profiles.UserProfile"
            ),
        ),
        migrations.AddField(
            model_name="message",
            name="conversation",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="msg_app.Conversation", verbose_name="Conversation"
            ),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                help_text="for select multiple press ctrl and click on field",
                related_name="conversations",
                through="msg_app.ConversationMembership",
                to="profiles.UserProfile",
