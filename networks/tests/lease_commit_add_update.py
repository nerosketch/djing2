...
class LeaseCommitAddUpdateTestCase(CustomAPITestCase):
    ...
    def _make_event_request(self, client_ip: str, client_mac: str, switch_mac: str,
        ...
        r = self.client.get('/api/networks/dhcp_lever/', data=request_data,
                            SERVER_NAME='example.com', **hdrs)
    ...
    def test_ok(self):
        r = self._make_event_request('10.11.12.55', '12:13:14:15:16:15',
                                     '12:13:14:15:16:17', 2, 'commit')
        self.assertDictEqual(r, {
            'text': 'Assigned 10.11.12.55'
        })

    @override_settings(API_AUTH_SECRET="sdfsdf")
    def test_update_last_update_time(self):
        r = self._make_event_request('10.11.12.60', '12:13:14:15:16:20',
                                     '12:13:14:15:16:17', 2, 'commit')
        self.assertDictEqual(r, {
            'text': 'Assigned 10.11.12.60'
        })
        r = self._make_event_request('10.11.12.60', '12:13:14:15:16:20',
                                     '12:13:14:15:16:17', 2, 'commit')
        self.assertDictEqual(r, {
    ...
    def test_ip_lease_logging_new_lease(self):
        ...
        # print('lease_time', log.lease_time)
        # print('last_update', log.last_update)
        # print('event_time', log.event_time)
        # print('end_use_time', log.end_use_time)
    ...
    def test_ip_lease_logging_repeated_lease(self):
        self._make_event_request('10.11.12.60', '12:13:14:15:16:20',
                                 '12:13:14:15:16:17', 2, 'commit')
        r = self._make_event_request('10.11.12.60', '12:13:14:15:16:20',
                                     '12:13:14:15:16:17', 2, 'commit')
        self.assertDictEqual(r, {
    ...
    def test_ip_lease_logging_old_lease_2_logs(self):
        self._make_event_request('10.11.12.60', '12:13:14:15:16:20',
                                 '12:13:14:15:16:17', 2, 'commit')
        self._make_event_request('10.11.12.61', '12:13:14:15:16:21',
                                 '12:13:14:15:16:17', 2, 'commit')
        logs = CustomerIpLeaseLog.objects.filter(
            customer=self.customer,
        )
    ...
    def test_ip_lease_log_time(self):
        ...
        # print('First event time start:', datetime.now())
        self._make_event_request('10.11.12.60', '12:13:14:15:16:20',
                                 '12:13:14:15:16:17', 2, 'commit')
        # print('First event time end:', datetime.now())
        # print('Start sleeping', datetime.now())

        # r = self._sleep_db()
        # print('SLEEPP:', r)

        # print('End sleeping', datetime.now())
        # device_onu, customer2
        # print('Second event time start:', datetime.now())
        self._make_event_request('10.11.12.60', '12:13:14:15:16:21',
                                 '11:13:14:15:16:18', 0, 'commit')
        # print('Second event time end:', datetime.now())
        ...
        # print('c1 lease_time', log_customer1.lease_time)
        # print('c1 pk', log_customer1.pk)
        # print('c1 last_update', log_customer1.last_update)
        # print('c1 event_time', log_customer1.event_time)
        # print('c1 end_use_time', log_customer1.end_use_time)
        ...
        # print('c2 lease_time', log_customer2.lease_time)
        # print('c2 pk', log_customer2.pk)
        # print('c2 last_update', log_customer2.last_update)
        # print('c2 event_time', log_customer2.event_time)
        # print('c2 end_use_time', log_customer2.end_use_time)
