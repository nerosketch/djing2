    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('priority', models.PositiveSmallIntegerField(choices=[(0, 'Low'), (1, 'Average'), (2, 'Higher')], default=0, verbose_name='A priority')),
                ...
                ('author', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='profiles.UserProfile', verbose_name='Task author')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='customers.Customer', verbose_name='Customer')),
                ('recipients', models.ManyToManyField(related_name='them_task', to='profiles.UserProfile', verbose_name='Recipients')),
            ],
            options={
                'db_table': 'task',
                'ordering': ('-id',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('act_type', models.PositiveSmallIntegerField(choices=[(1, 'Change task'), (2, 'Create task'), (3, 'Delete task'), (4, 'Completing tasks'), (5, 'The task failed')])),
                ('when', models.DateTimeField(auto_now_add=True)),
                ('task', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tasks.Task')),
                ('who', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='profiles.UserProfile')),
            ],
            options={
